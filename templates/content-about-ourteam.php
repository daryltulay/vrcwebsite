			...
			<div class="row clearfix">
				...
				<div class="col-xs-4 column">
					<ul class="list-unstyled listify">	
						<li id="listings">SAGAY: Tubbataha Marine Life Sanctuary
				...
				<div class="col-xs-4 column">
					<ul class="list-unstyled listify">
						<li id="listings">AMA Computer University
...
Baguio City, Philippines<br></li>
						<li id="listings">AMA University
							Las Pinas </li>
				</ul>
				</div>
				<div class="col-xs-4 column">
					<ul class="list-unstyled listify">
						<li id="listings">THREE-STOREY TOWNHOUSE Cebu City<br></li>
						<li id="listings">38 - STOREY CONDOMINIUM OFFICE TOWER GOLDLAND PROPERTIES & DEVELOPMENT CORP. Timog Avenue, Quezon City<br></li>
						<li id="listings">THREE STOREY MIXED USE COMMERCIAL BLDG. Antipolo City<br></li>
						<li id="listings">OFFICE TERMINAL BLDG.Lipa City,Batangas<br></li>
						<li id="listings">THREE-STOREY HOUSE Manila</li>
				</ul>
				</div>
...
Angeles City, Pampanga<br></li>
				...
				<div class="col-xs-4 column">
					<ul class="list-unstyled listify">
						<li id="listings">Build A Bench
International Design Competition 2013
Kowloon East, Hong Kong<br></li>
						<li id="listings">Belgorod City Centre 
International Competition 2013<br></li>
						<li id="listings">Proposed 7-Storey Condotel
Pagsanjan, Laguna<br></li>
						<li id="listings">THREE-STOREY TOWNHOUSE
Cebu City<br></li>
				</ul>
...
311 Shaw Blvd., Mandaluyong City<br></li>
				...
				<div class="col-xs-4 column">
					<ul class="list-unstyled listify">
						<li id="listings">Immaculate Conception Parish
